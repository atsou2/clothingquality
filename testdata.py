...
root_dir = '/Users/adamtsou/clothingquality/clothing_v3_data/test100'
...
timestamp_file = '/Users/adamtsou/clothingquality/test_timestamps.json'

# Traverse the directory structure (station -> month -> images)
for station_folder in os.listdir(root_dir):
    print(f"Checking station folder: {station_folder}") # Print the current station folder
                ...
                for filename in tqdm(os.listdir(month_path)):
                    ...
                    if match:
                        ...
                        with Image.open(img_path) as img:
                            ...
                            new_img_path = f'/Users/adamtsou/clothingquality/new_data/test100/{station_folder}/{month_folder}/{img_type}_{timestamp}.jpg'
